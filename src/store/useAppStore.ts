...
export const INITIAL_APPS: AppItem[] = [
  {
    ...
    icon: 'Code2',
    pathOrUrl: 'C:\\Users\\avina\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe',
    type: 'exe',
  ...
  },
  {
    ...
    icon: 'Gamepad2',
    pathOrUrl: 'C:\\Program Files (x86)\\Steam\\steam.exe',
    type: 'exe',
    category: 'Gaming',
    isPinned: true,
    launchCount: 15,
  ...
  },
  {
    ...
    title: 'Discord App',
    icon: 'MessageSquare',
    pathOrUrl: 'https://discord.com/app',
    type: 'url',
    category: 'Media',
    isPinned: true,
    launchCount: 27,
